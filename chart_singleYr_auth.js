...
$('#ddRanch, #ddPasture, #ddMeasure, #radInterval, #radClimate, #ddYear').change(function() {
   updateGridmet();
   updateSeasonProg();
   updateStats();
});
...
function seaprogFunc(arr2) {
   ...
   for(var i = 0; i < arr2[Object.keys(arr2)[0]].length; i++) {
      ...
      //var j = i + 1;
      //if(j < 10) { j = '0' + j; }
      //date_sp.push( yr + '-' + j + '-01' );
      //month_sp.push(arr2[Object.keys(arr2)[0]][i].month);
