...
info.update = function () {
   this._div.innerHTML = '<div style="background:#fff;opacity:0.7;border-radius:6px;padding:4px 6px"><h4>The Nature Conservancy</h4><span style="font-size:14px"><strong>' + indicator.toUpperCase() + ', ' + selScene.substring(21,23) + '/' + selScene.substring(23,25) + '/' +  selScene.substring(17,21) + '</strong></span></div>';
};
